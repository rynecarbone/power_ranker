[![version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/rynecarbone/power-ranker/blob/master/CHANGELOG.md) [![PyPI version](https://badge.fury.io/py/power_ranker.svg)](https://badge.fury.io/py/power-ranker)
